...
from app.db import Users, get_user_db
...
fastapi_users = FastAPIUsers[Users, uuid.UUID](get_user_manager, auth_backends=[auth_backend])
current_activae_user = fastapi_users.current_user(active=True)
